...
public class HomeModel extends BaseModel {
     ...
     * @param onError           失败回调
     */
    public void getHomeInfo(double longitude, double latitude, String province,
                            String city, String district, int expo_cid, int community_cid,
                            @NonNull LifecycleProvider lifecycleProvider, @Nullable Consumer<HomeInfoBean> onNext,
