...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.c));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.c));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.colorTheme));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.colorTheme));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.c));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.c));
        }
    }
